// Datos de productos
const products = [
    { id: 1, name: 'Bistec Ranchero', price: 60.00 },
    { id: 2, name: 'Huevos Rancheros', price: 50.00 },
    { id: 3, name: 'Torta De Huevo', price: 45.00 },
    { id: 4, name: 'Cemita De Quesillo', price: 40.00 },
    { id: 5, name: 'Cemita De Carne', price: 40.00 },
    { id: 6, name: 'Bistec', price: 60.00 },
    { id: 7, name: 'Molotes De Quesillo', price: 35.00 },
    { id: 8, name: 'Taco De Milanesa', price: 40.00 },
];
